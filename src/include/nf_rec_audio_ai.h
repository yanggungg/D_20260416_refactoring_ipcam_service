...
typedef enum _NF_REC_AUDIO_AI_TYPE_E
{
	NF_REC_AUDIO_AI_EVENT_INTRUSION		= 0,
	NF_REC_AUDIO_AI_EVENT_ENTER			= 1,
	NF_REC_AUDIO_AI_EVENT_EXIT			= 2,
	NF_REC_AUDIO_AI_EVENT_REMOVED		= 3,
	NF_REC_AUDIO_AI_EVENT_LOITERED		= 4,
	NF_REC_AUDIO_AI_EVENT_STOPPED		= 5,
	NF_REC_AUDIO_AI_EVENT_DIR_POS		= 6,
	NF_REC_AUDIO_AI_EVENT_DIR_NEG		= 7,

	NF_REC_AUDIO_AI_EVENT_NR
} NF_REC_AUDIO_AI_TYPE;
