...
typedef enum _DR_PTZ_CMD_E { 
	...
	DR_PTZ_CMD_SWING,
	DR_PTZ_CMD_SWING_STOP,		// 0x0C
	
	DR_PTZ_CMD_PATTERN_START,
	DR_PTZ_CMD_PATTERN_STOP,	
	DR_PTZ_CMD_PATTERN_RUN,	
	DR_PTZ_CMD_IRIS_OPEN,		// 0x10
	DR_PTZ_CMD_IRIS_CLOSE,
	DR_PTZ_CMD_AUTO_PEN,
	DR_PTZ_CMD_SEQUENCE,		// 0x13

	DR_PTZ_CMD_PAN_LEFT_UP,		// 0x14
	DR_PTZ_CMD_PAN_LEFT_DOWN,
	DR_PTZ_CMD_PAN_RIGHT_UP,
	DR_PTZ_CMD_PAN_RIGHT_DOWN,
