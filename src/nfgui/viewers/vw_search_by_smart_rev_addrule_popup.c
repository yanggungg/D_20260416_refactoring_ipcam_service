/*
 * vw_search_by_smart_rev_addrule_popup.c
 *
 * Written by Eunhye. <eun@itxsecurity.com>
 * Copyright (c) ITX security, June 23, 2014
 *
 */
...
gint vw_search_by_smart_rev_addrule_popup_open(NFOBJECT *parent, gint ch, time_t frame_time)
{
    NFOBJECT *win;
    NFOBJECT *fixed;   
    NFOBJECT *obj;
...
// VIDEO FIXED
    ...
    nfui_nfobject_show(fixed);
    nfui_nffixed_put((NFFIXED*)main_fixed, fixed, 21, 60+(WIN_HEIGHT-60-VIDEO_COMPONENT_HEIGHT)/2);
    g_video_fixed = fixed;
