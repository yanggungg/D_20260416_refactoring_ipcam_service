...
#define CONTENT_STR             "You may now configure recording settings.\n\nYou may select the desired recording mode and resolution."
...
gint vw_wizard_record_instruction_open(gpointer parent, gpointer user_data)
{
	...
	nfui_nfwindow_set_title(main_wnd, "SETUP WIZARD INIT");
	...
	nfui_nfobject_set_size(lbTemp, PI_FIXED_SIZE_WID, 110);
