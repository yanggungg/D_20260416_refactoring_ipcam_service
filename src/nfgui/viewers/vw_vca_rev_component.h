...
#ifndef	__VCA_REV_COMPONENT_H
#define __VCA_REV_COMPONENT_H
...
#define DEFAULT_COMPONENT_HEIGHT        (756)

#define VIDEO_COMPONENT_WIDTH           (16*58)
#define VIDEO_COMPONENT_HEIGHT          (9*58)

#define VCA_COMPONENT_DATA              "vca_component_data"
#define VCA_COMPONENT_ACTION            "vca_component_action"
...
typedef struct _COMPONENT_PREVIEW_T {
    ...
    gint        onoff;
    gint        bg_color;
    gint        rule_mode;      // 0 : rule, 1 : calibration
} COMPONENT_PREVIEW_T;
...
typedef struct _VCA_COMPONENT_DATA_T {
    gint                    act_license;
    gint                    act_capable;
    gint                    disable_event;    
...
gint vw_vca_rev_unit_setup_component_open(NFOBJECT *parent, guint opt);
gint vw_vca_rev_unit_setup_component_show();
gint vw_vca_rev_unit_setup_component_hide();
gint vw_vca_rev_unit_setup_component_sync_data(NFOBJECT *parent);
gint vw_vca_rev_unit_setup_component_expose(NFOBJECT *parent);
...
gint vw_vca_rev_calibration_adrz_component_open(NFOBJECT *parent, guint opt);
gint vw_vca_rev_calibration_adrz_component_show();
gint vw_vca_rev_calibration_adrz_component_hide();
gint vw_vca_rev_calibration_adrz_component_sync_data(NFOBJECT *parent);
gint vw_vca_rev_calibration_adrz_component_expose_data(NFOBJECT *parent);
gint vw_vca_rev_calibration_adrz_component_expose(NFOBJECT *parent);
...
gint vw_vca_rev_rule_setup_component_open(NFOBJECT *parent, guint opt);
gint vw_vca_rev_rule_setup_component_show();
gint vw_vca_rev_rule_setup_component_hide();
gint vw_vca_rev_rule_setup_component_sync_data(NFOBJECT *parent);
gint vw_vca_rev_rule_setup_component_expose(NFOBJECT *parent);
...
gint vw_vca_rev_rule_line_component_open(NFOBJECT *parent, guint opt);
gint vw_vca_rev_rule_line_component_show();
gint vw_vca_rev_rule_line_component_hide();
gint vw_vca_rev_rule_line_component_sync_data(NFOBJECT *parent);
gint vw_vca_rev_rule_line_component_expose(NFOBJECT *parent);
...
gint vw_vca_rev_option_component_open(NFOBJECT *parent, guint opt);
gint vw_vca_rev_option_component_show();
gint vw_vca_rev_option_component_hide();
gint vw_vca_rev_option_component_sync_data(NFOBJECT *parent);
gint vw_vca_rev_option_component_expose(NFOBJECT *parent);
