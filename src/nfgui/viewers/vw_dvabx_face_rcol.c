...
gint _dvabx_face_rcol_page(NFOBJECT *parent)
{
...
gint _dvabx_face_rcol_show_page(gint page, gint expose)
{
	NFOBJECT *top;
    DVA_COMPONENT_DATA_T *component_data;
    DVAAID dvaaid;
...
gint _dvabx_face_rcol_hide_page(gint expose)
{
    if (!g_parent) return 0;
