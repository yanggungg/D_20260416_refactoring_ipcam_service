...
// Set up input values for first round
    L0 = ((volatile DWORD *)pbData)[0];
    L1 = ((volatile DWORD *)pbData)[1];
    R0 = ((volatile DWORD *)pbData)[2];
    R1 = ((volatile DWORD *)pbData)[3];
...
// Copy output values from last round to pbData
    ((volatile DWORD *)pbData)[0] = R0;
    ((volatile DWORD *)pbData)[1] = R1;
    ((volatile DWORD *)pbData)[2] = L0;
    ((volatile DWORD *)pbData)[3] = L1;
}
